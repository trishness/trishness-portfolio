      ...
      <div className=" background rounded about">
        ...
        <div className="row">
          <div className="col-md-12 sm-12 bg justify-content-center">
            <p className="center background rounded">My name is Trish and I am a certified fullstack web developer with an inclination towards front-end development. Post graduation from the University of Washington, I entered into various roles including management and office administration. This versatile professional history has embedded strong beliefs in teamwork, critical thinking, and attention to detail within my core. I am a highly motivated person that strives to not only achieve, but exceed expectations for every set goal. My genial yet professional disposition has been revered by both clients and coworkers, enabling rapid professional growth and solidifying essential connections in each workplace. Combined with my ability to learn quickly, I have proven to be an asset to each company I have been a part of.
          <br />
              <br />
